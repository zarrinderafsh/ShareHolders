...
public class SyncProjectsPicGetImage {
	...
	//Contractor
	public SyncProjectsPicGetImage(Activity activity,String PGuid,String ImageId,String NewsId,boolean ShowDialog) {
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        db.execSQL("update projects set pic='"+AllRecord+"' where id="+CuNewsId);
        
        if(GetNewsPicFromTempTbl(CuNewsId)==0)
        {
        	db = dbh.getWritableDatabase();
        	db.execSQL("insert into projectpic (id,pic)  values("+CuNewsId+",'"+AllRecord+"')");
        }
