...
public class SyncProjects {
	...
	//Contractor
	public SyncProjects(Activity activity,String PGuid,boolean ShowDialog,boolean LoadActivityAfterExecute) {
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
		...
		{
			LoadActivity(Projects.class, "PGuid", PGuid);
		}
