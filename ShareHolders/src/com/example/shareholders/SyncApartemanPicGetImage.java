...
public class SyncApartemanPicGetImage {
	...
	//Contractor
	public SyncApartemanPicGetImage(Activity activity,String PGuid,String ImageId,String NewsId,boolean ShowDialog) {
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        db.execSQL("update aparteman set pic='"+AllRecord+"' where code="+CuNewsId);
        db.close();
        dbh.close();
    }
