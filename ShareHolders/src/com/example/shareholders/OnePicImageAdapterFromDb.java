...
public class OnePicImageAdapterFromDb extends BaseAdapter {
    int mGalleryItemBackground;
    private Context mContext;
 
    private Bitmap[] CuPicId ;
 
    public OnePicImageAdapterFromDb(Context c,Bitmap[] PicId) {
        mContext = c;
        CuPicId = new Bitmap[PicId.length];
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	Oldimg.setImageBitmap(CuPicId[position]);
