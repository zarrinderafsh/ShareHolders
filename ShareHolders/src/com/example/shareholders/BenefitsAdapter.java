...
//			holder.txtdate.setTextSize(22);
		...
		holder.txtPrice.setText(Html.fromHtml(map.get("title") +" به ازای هر تک سهم "+ "<br />" +"مبلغ " + " " + FinalPriceMin.substring(0, FinalPriceMin.length()-3) + " ریال"+ "<br />" +"میباشد"));
		return convertView;
	}
