...
public class SyncPicGalleryGetImage {
	...
	//Contractor
	public SyncPicGalleryGetImage(Activity activity,String PGuid,boolean ShowDialog) {
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        db.execSQL("update picgallery set pic='"+AllRecord+"' where pic='"+CuImageId+"'");
        db.close();
        dbh.close();
    }
