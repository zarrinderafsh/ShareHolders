...
public class MessageSendboxAdapter extends BaseAdapter {
	public ArrayList<HashMap<String, String>> list;
	Activity activity;
	InternetConnection IC;

	public MessageSendboxAdapter(Activity activity,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.txtdate.setText("گیرنده : "+map.get("receiverId"));
	...
	private class AsyncCallWSSendCancelRequestN extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            	...
            	try
            	{
            		CallWsMethodLogin("DeleteMessageOutbox",cuReqId,cuPGuid);
            	}
    	    	catch (Exception e) {
        ...
        protected void onPostExecute(String result) {
            if(WsResault.toLowerCase().compareTo("1")==0)
            {
            	...
            	//update Buy And Sell Requests
					...
					SyncMessageSendbox SBASR2 = new SyncMessageSendbox(activity, cuPGuid,true,true);
					SBASR2.AsyncExecute();
