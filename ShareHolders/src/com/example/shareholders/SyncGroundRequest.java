...
public class SyncGroundRequest {
	...
	//Contractor
	public SyncGroundRequest(Activity activity,String PGuid,boolean ShowDialog,boolean LoadActivityAfterExecute) {
        ...
        protected void onPostExecute(String result) {
        	if(result == null)
        	{
	            ...
	            else if(WsResponse.toString().compareTo("Nothing") == 0)
	            {
	                ...
	                db.execSQL("delete from AptGroRequest where RequestType = 2");
	            	WsResponse = "Nothing";
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        for(int i = 0 ; i < CuAllRecord.length;i++)
        {
            ...
            if(AllFields.length > 0)
            {
            	...
            	" values("+AllFields[0].toString()+",2,'"+AllFields[1].toString()+"','"+AllFields[2].toString()+"','"+AllFields[3].toString()+"','"+AllFields[4].toString()+"')");
            }
        }
