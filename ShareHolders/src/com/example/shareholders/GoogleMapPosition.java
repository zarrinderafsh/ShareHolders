...
public class GoogleMapPosition extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.google_map_position);
        ...
        if(IC.isConnectingToInternet()==true)
		{
        	try
			{
        		AsyncCallLoadGoogleMap task = new AsyncCallLoadGoogleMap(GoogleMapPosition.this);
             task.execute();
			}	
			 catch (Exception e) {
	...
	private void ExitApplication()
	{
		//Exit All Activity And Kill Application
		 Builder alertbox = new AlertDialog.Builder(GoogleMapPosition.this);
	...
	public boolean onKeyDown( int keyCode, KeyEvent event )  {
	    if ( keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0 ) {
	    	LoadActivity(AboutUs.class, "PGuid", PersonGuid);
	        return true;
	    }
