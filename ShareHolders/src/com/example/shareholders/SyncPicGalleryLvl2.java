...
public class SyncPicGalleryLvl2 {
	...
	//Contractor
	public SyncPicGalleryLvl2(Activity activity,String PGuid,boolean ShowDialog,boolean LoadActivityAfterExecute) {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
        	...
        	try
        	{
        		CallWsMethod("GetPictureGalleryLvl2");
        	}
	    	catch (Exception e) {
        ...
        protected void onPostExecute(String result) {
        	if(result == null)
        	{
	            ...
	            else if(WsResponse.toString().compareTo("Nothing") == 0)
	            {
	                ...
	                db.execSQL("delete from picgallerylvl2");
	            	WsResponse = "Nothing";
	            }
	            else
	            {
