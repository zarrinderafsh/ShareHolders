...
public class SyncApartemanRequest {
	...
	//Contractor
	public SyncApartemanRequest(Activity activity,String PGuid,boolean ShowDialog,boolean LoadActivityAfterExecute) {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
        	...
        	try
        	{
        		CallWsMethod("GetApartemanRequest");
        	}
	    	catch (Exception e) {
        ...
        protected void onPostExecute(String result) {
        	if(result == null)
        	{
	            ...
	            else if(WsResponse.toString().compareTo("Nothing") == 0)
	            {
	                ...
	                db.execSQL("delete from AptGroRequest where RequestType = 1");
	            	WsResponse = "Nothing";
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        for(int i = 0 ; i < CuAllRecord.length;i++)
        {
            ...
            if(AllFields.length > 0)
            {
            	...
            	db = dbh.getWritableDatabase();
            	db.execSQL("insert into AptGroRequest(Code,RequestType,ObjectCode,GroundAparteman,Status,InsertDate)"+
            	" values("+AllFields[0].toString()+",1,'"+AllFields[1].toString()+"','"+AllFields[2].toString()+"','"+AllFields[3].toString()+"','"+AllFields[4].toString()+"')");
            }
        }
	...
	public void LoadActivity(Class<?> Cls,String VariableName,String VariableValue)
	{
		...
		intent.putExtra("RequestTab", "Request");
