...
public class SyncGround {
	...
	//Contractor
	public SyncGround(Activity activity,String PGuid,boolean ShowDialog,boolean LoadActivityAfterExecute) {
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        for(int i = 0 ; i < CuAllRecord.length;i++)
        {
            ...
            if(AllFields.length > 0)
            {
            	...
            	db = dbh.getWritableDatabase();
            	db.execSQL("insert into ground(Code,Metraj,Abad,MogheeyatJoghrafi,MogheeyatMakani,Address,Sanad,TedadShoraka,Tozihat,Gheymat)"+
            	" values("+AllFields[0].toString()+",'"+AllFields[1].toString()+"','"+AllFields[2].toString()+"','"+AllFields[3].toString()+"','"+AllFields[4].toString()+"','"+AllFields[5].toString()+"','"+AllFields[6].toString()+"','"+AllFields[7].toString()+"','"+AllFields[8].toString()+"','"+AllFields[9].toString()+"')");
            }
        }
