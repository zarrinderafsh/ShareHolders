...
public class SyncPicGalleryLvl1GetImage {
	...
	//Contractor
	public SyncPicGalleryLvl1GetImage(Activity activity,String PGuid,String ImageId,String NewsId,boolean ShowDialog) {
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        db.execSQL("update picgallerylvl1 set pic='"+AllRecord+"' where code="+CuNewsId);
        
        if(GetNewsPicFromTempTbl(CuNewsId)==0)
        {
        	db = dbh.getWritableDatabase();
        	db.execSQL("insert into picgallerylvl1pic (id,pic)  values("+CuNewsId+",'"+AllRecord+"')");
        }
