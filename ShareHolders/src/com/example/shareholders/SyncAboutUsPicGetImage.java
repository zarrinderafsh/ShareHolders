...
public class SyncAboutUsPicGetImage {
	...
	//Contractor
	public SyncAboutUsPicGetImage(Activity activity,String PGuid,String ImageId,boolean ShowDialog) {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
        	if(result == null)
        	{
	            ...
	            {
	            	//Toast.makeText(this.activity.getApplicationContext(), PersianReshape.reshape("خطا در بروزرسانی عکس درباره ما"), Toast.LENGTH_LONG).show();
	            }
	            else
	            {
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
        ...
        db.execSQL("update aboutus set pic='"+AllRecord+"'");
        db.close();
        dbh.close();
    }
