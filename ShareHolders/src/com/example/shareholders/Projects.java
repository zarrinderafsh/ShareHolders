...
public class Projects extends Activity {
    ...
    private void FillData()
	{
		...
		Cursor cursors = db.rawQuery("select * from projects order by sDate desc", null);
...
//				{
			...
			adapter = new ProjectsAdapter(this, DataLList);
	...
	private void ExitApplication()
	{
		//Exit All Activity And Kill Application
		 Builder alertbox = new AlertDialog.Builder(Projects.this);
