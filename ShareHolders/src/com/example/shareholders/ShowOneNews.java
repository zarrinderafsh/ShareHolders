...
public class ShowOneNews extends Activity {
...
//        mJTv.setTypeFace(FontMitra);
    ...
    private void FillData(String Id)
	{
		...
		Cursor cursors = db.rawQuery("select * from news where id = "+Id, null);
...
//			view.loadData(text, "text/html", "utf-8");
			...
			txtNewsDiscription.setText(Html.fromHtml(text));
...
//			{
	...
	private void ExitApplication()
	{
		//Exit All Activity And Kill Application
		 Builder alertbox = new AlertDialog.Builder(ShowOneNews.this);
